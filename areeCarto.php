            ...
            <div id="content">
                ...
                <div id="skArcheoContent">
                    <div class="inner primo">
                        <div>
                            <?php if($usr) {include("inc/areeCartoNew.php"); } ?>        
                                ...
                                <div style="float:right">
                                    <form action="areeCarto.php" id="filtra" method="get" enctype="text/plain">
                                        ...
                                        <select id="c" name="c" class="filtri" style="width:200px;">
                                            ...
                                            <?php
                                            $qf = ("SELECT DISTINCT aree.id_comune, comune.comune, comune.cap AS cap_comune FROM aree, comune WHERE aree.id_comune = comune.id and aree.tipo = 3 order by comune asc;");
