...
<body>
 <div id="container" style="font-family: 'Oxygen', sans-serif; font-size:10px">
  <div id="wrap">
   ...
   <div id="content">
     ...
     <div id="skArcheoContent">
      <div class="inner primo" style="border-width:2px; border-color:#FFBF96"">
	...
	<div style="float:right; width:45%;">
	 <div id="campo"> 
      ...
      <div class="inner primo" style="height:220px;">
        <div id="wrapCheckTipo">
          <div class="checkbox_archeo">
	    <input type="checkbox" value="6" id="checkbox_archeo" name="check" class="filtri" />
	    <label for="checkbox_archeo" title="ARCHEOLOGICA" ></label>
	   </div>
	   <div class="checkbox_archit">
	    <input type="checkbox" value="8" id="checkbox_archit" name="check" class="filtri"/>
	    <label for="checkbox_archit" title="ARCHITETTONICA"></label>
	   </div>
	   <div class="checkbox_archiv">
	    <input type="checkbox" value="4" id="checkbox_archiv" name="check" class="filtri"/>
	    <label for="checkbox_archiv" title="ARCHIVISTICA"></label>
	   </div>
	   <div class="checkbox_biblio">
	    <input type="checkbox" value="5" id="checkbox_biblio" name="check" class="filtri"/>
	    <label for="checkbox_biblio" title="BIBLIOGRAFICA"></label>
	   </div>
	   <div class="checkbox_mater">
	    <input type="checkbox" value="2" id="checkbox_mater" name="check" class="filtri"/>
	    <label for="checkbox_mater" title="FONTE MATERIALE"></label>
	   </div>
	   <div class="checkbox_oral">
	    <input type="checkbox" value="1" id="checkbox_oral" name="check" class="filtri"/>
	    <label for="checkbox_oral" title="FONTE ORALE"></label>
           </div>
	   <div class="checkbox_foto">
	    <input type="checkbox" value="7" id="checkbox_foto" name="check" class="filtri"/>
	    <label for="checkbox_foto" title="FOTOGRAFICA"></label>
	   </div>
	   <div class="checkbox_stoart">
	    <input type="checkbox" value="9" id="checkbox_stoart" name="check" class="filtri"/>
	    <label for="checkbox_stoart" title="STORICO ARTISTICA"></label>
	   </div>
        </div>
        <div id="wrapCheckLivello">
           <div class="checkbox_1" >
	    <input type="checkbox" value="1" id="checkbox_1" name="check" class="filtri"/>
	    <label for="checkbox_1" title="PRIMO LIVELLO"></label>
	   </div>
	   <div class="checkbox_2">
	    <input type="checkbox" value="2" id="checkbox_2" name="check" class="filtri"/>
            <label for="checkbox_2" title="SECONDO LIVELLO"></label>
	   </div>
	   <div class="checkbox_3">
	    <input type="checkbox" value="3" id="checkbox_3" name="check" class="filtri"/>
            <label for="checkbox_3" title="TERZO LIVELLO"></label>
	   </div>
        </div>
        <div id="wrapSlider">
          <div id="sliderLegend">cronologia iniziale | cronologia finale </div>
	 ...
	 <div style="float:right; width:70%; margin-top:14px;"><legend id="legenda" style="font-size: 30px; font-weight: bold; color:#907F73;"></legend></div>
      ...
      <div class="inner primo">
       <table id="catalogoTable" style="width:100% !important;">
        <caption></caption>
        <thead>
         <tr>
          <th style="width:90px;">NUM.SCH.</th>
          <th style="width:100px;">LIV.IND.</th>
          <th style="width:270px;">OGGETTO</th>
...
<!--
	...
	input[type="checkbox_archeo"] {width:80px;height:80px;background:url('img/icone/button_archeo.png') center center no-repeat;background-size: contain;cursor:pointer;}
	input[type="checkbox_archit"] {width:80px;height:80px;background:url('img/icone/button_archit.png') center center no-repeat;background-size: contain;cursor:pointer;}
	input[type="checkbox_archiv"] {width:80px;height:80px;background:url('img/icone/button_archiv.png') center center no-repeat;background-size: contain;cursor:pointer;}
	input[type="checkbox_biblio"] {width:80px;height:80px;background:url('img/icone/button_biblio.png') center center no-repeat;background-size: contain;cursor:pointer;}
	input[type="checkbox_stoart"] {width:80px;height:80px;background:url('img/icone/button_stoart.png') center center no-repeat;background-size: contain;cursor:pointer;}
	input[type="checkbox_mater"] {width:80px;height:80px;background:url('img/icone/button_mater.png') center center no-repeat;background-size: contain;cursor:pointer;}
	input[type="checkbox_oral"] {width:80px;height:80px;background:url('img/icone/button_oral.png') center center no-repeat;background-size: contain;cursor:pointer;}
	input[type="checkbox_foto"] {width:80px;height:80px;background:url('img/icone/button_foto.png') center center no-repeat;background-size: contain;cursor:pointer;}
	--!>
