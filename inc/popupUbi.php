...
with listone as(
 with a as
  (SELECT madre.id AS id_madre, madre.dgn_numsch AS madre, madre.livello AS liv_madre, figlia.id AS id_figlia, figlia.dgn_numsch AS figlia, figlia.livello AS liv_figlia FROM altrif_parenti alt_madre, ubicazione, aree, aree_scheda, scheda, scheda madre, scheda figlia WHERE alt_madre.id_scheda = scheda.id AND  alt_madre.id_scheda = madre.id AND alt_madre.id_parente = figlia.id AND ubicazione.area = aree.id AND aree_scheda.id_area = aree.id AND aree_scheda.id_scheda = scheda.id AND madre.livello = 1 AND ubicazione.id = $id)
,b as 
  (SELECT madre.id AS id_madre, madre.dgn_numsch AS madre, madre.livello AS liv_madre, figlia.id AS id_figlia, figlia.dgn_numsch AS figlia, figlia.livello AS liv_figlia FROM altrif_parenti alt_madre, ubicazione, aree, aree_scheda, scheda, scheda madre, scheda figlia WHERE alt_madre.id_scheda = scheda.id AND  alt_madre.id_scheda = madre.id AND alt_madre.id_parente = figlia.id AND ubicazione.area = aree.id AND aree_scheda.id_area = aree.id AND aree_scheda.id_scheda = scheda.id AND madre.livello = 2 AND ubicazione.id = $id)
,c as 
  (SELECT madre.id AS id_madre, madre.dgn_numsch AS madre, madre.livello AS liv_madre, figlia.id AS id_figlia, figlia.dgn_numsch AS figlia, figlia.livello AS liv_figlia FROM altrif_parenti alt_madre, ubicazione, aree, aree_scheda, scheda, scheda madre, scheda figlia WHERE alt_madre.id_scheda = scheda.id AND  alt_madre.id_scheda = madre.id AND alt_madre.id_parente = figlia.id AND ubicazione.area = aree.id AND aree_scheda.id_area = aree.id AND aree_scheda.id_scheda = scheda.id AND madre.livello = 3 AND ubicazione.id = $id)
,d as 
  (SELECT scheda.id as id_madre, scheda.dgn_numsch as madre FROM ubicazione, aree, aree_scheda, scheda WHERE ubicazione.area = aree.id AND aree_scheda.id_area = aree.id AND aree_scheda.id_scheda = scheda.id AND ubicazione.id = $id)
