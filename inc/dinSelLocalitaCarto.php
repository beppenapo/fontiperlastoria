...
if($_POST['id']){
 ...
 if($righe > 0){
  echo '<label class="labelInput" for="lcAll" style="font-weight:bold;"><input type="checkbox" id="lcAll" name="localitaCartoCheckAll" />Seleziona/deseleziona tutto</label>';
