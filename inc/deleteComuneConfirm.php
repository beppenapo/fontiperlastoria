...
<div class="confirm">
 ...
 <h2>Stai per eliminare il record <?php echo($def); ?> dalla tabella Comune</h2>
...
$(document).ready(function() {
 ...
 $('.elimina').each(function(){
   $(this).click(function(){
  	 var id= $('input#id').val();
 	 $.ajax({
      url: 'inc/deleteComuneScript.php',
      type: 'POST', 
      data: {id:id}, 
      success: function(data){
      	//$('#qtip-delete-comune'+id).qtip('destroy');
         //$('table#vocabolariTable tbody tr#comune'+id).hide();
         $(data)
