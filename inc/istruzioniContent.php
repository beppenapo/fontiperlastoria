...
<div class="toggle sezioni">
 <h2><span class="ui-icon ui-icon-circle-plus"></span>Come navigare nella mappa</h2>
 <div class="slide">
  <p>Il pannello degli <b>strumenti</b> <i>pan</i> (spostamento) e <i>zoom</i> (ingrandimento) è in basso a sinistra.</p>
  <p>Partendo dall’alto, i pulsanti <b>+</b> e <b>–</b> servono per aumentare e diminuire lo <b>zoom</b> della mappa (lo zoom si ottiene anche con il doppio click).<br>
 Premendo il pulsante “<b>mondo</b>” tra il + ed il – si resetta lo zoom per tornare alla scala di partenza.</p>
...
<div class="toggle sezioni">
 <h2><span class="ui-icon ui-icon-circle-plus"></span>Come utilizzare la cartografia di base</h2>
 <div class="slide">
...
<div class="toggle sezioni">
 <h2><span class="ui-icon ui-icon-circle-plus"></span>Come visualizzare le aree di interesse</h2>
 <div class="slide">
...
<div class="toggle sezioni">
 <h2><span class="ui-icon ui-icon-circle-plus"></span>Come interrogare le aree di interesse</h2>
 <div class="slide">
...
<div class="toggle sezioni">
 <h2><span class="ui-icon ui-icon-circle-plus"></span>Come visualizzare le ubicazioni</h2>
 <div class="slide">
...
<div class="toggle sezioni">
 <h2><span class="ui-icon ui-icon-circle-plus"></span>Come interrogare le ubicazioni</h2>
 <div class="slide">
...
<div class="toggle sezioni">
 <h2><span class="ui-icon ui-icon-circle-plus"></span>Prima di iniziare, la struttura in sintesi</h2>
 <div class="slide">
...
<div class="toggle sezioni">
 <h2><span class="ui-icon ui-icon-circle-plus"></span>Come eseguire una ricerca per parola chiave all'interno del catalogo</h2>
 <div class="slide">
...
Per facilitare la ricerca, non appena si digitano delle lettere nell’apposita stringa di immissione, compare una lista di <b>suggerimenti</b> dalla quale selezionare il vocabolo. <br> 
Scelto il vocabolo da ricercare, si clicca sul pulsante “lente di ingrandimento”. <br>
...
<div class="toggle sezioni">
 <h2><span class="ui-icon ui-icon-circle-plus"></span>Come eseguire una ricerca incrociata per parole chiave all'interno del catalogo</h2>
 <div class="slide">
...
Selezionando il comando “aggiungi parola”, si possono utilizzare fino a <b>tre chiavi di ricerca</b>, legate da diverse combinazioni logiche:</p>
 <p>– <b>AND</b> consente di visualizzare i record in cui sono presenti tutte le parole digitate;<br>
– <b>OR</b> seleziona i record in cui compare almeno una delle chiavi ricercate;<br>
– <b>NOT</b>, infine, serve per individuare i record che contengono una parola e che contemporaneamente ne escludono un’altra. </p>
 </div>
</div>

<div class="toggle sezioni">
 <h2><span class="ui-icon ui-icon-circle-plus"></span>Come filtrare le schede del catalogo</h2>
 <div class="slide">
  ...
  <p>– il <b>tipo di fonte</b>,<br>
 – il <b>livello di schedatura</b>,<br>
 – l’<b>arco cronologico</b>.</p>
  <p>Per applicare tali filtri basta selezionare, da sinistra, uno o più degli otto pulsanti che rappresentano i tipi di fonti presenti nel database; il livello od i livelli (primo, secondo o terzo) di schedatura prescelti e la cronologia, che può essere circoscritta utilizzando la barra del tempo. <br> 
Cliccando quindi il pulsate “scolapasta” si ottiene la lista dei record che rispettano i parametri stabiliti.<br>
Per condurre una nuova ricerca è necessario deselezionare (cliccandoci sopra) i filtri impostati o semplicemente aggiornare la pagina.</p>
 </div>
</div>

<div class="toggle sezioni">
 <h2><span class="ui-icon ui-icon-circle-plus"></span>Come eseguire una ricerca specifica all’interno di un determinato tipo e livello di scheda</h2>
 <div class="slide	">
  <p align="center"><img src="img/pagineFonti/wip.png" alt="Work in progress" /></p>
 </div>
</div>
</div>
