...
var aree_archeo, aree_archivi, aree_architett, aree_biblio, aree_cultmat,aree_cultmat_line, aree_foto, aree_orale, aree_stoart, ubicazione, aree_line, aree; //overlay
...
function init() {
 ...
 //var road = new OpenLayers.Layer.Bing({name: "Road",key: apiKey,type: "Road"});
 //var hybrid = new OpenLayers.Layer.Bing({name: "Hybrid",key: apiKey,type: "AerialWithLabels"});
 //var aerial = new OpenLayers.Layer.Bing({name: "Aerial",key: apiKey,type: "Aerial"});
...
listalayer= [aree_archeo, aree_archivi, aree_architett, aree_biblio, aree_cultmat,aree_cultmat_line, aree_foto, aree_orale, aree_stoart];
