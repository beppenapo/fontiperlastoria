...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="IT" >
 <head>
  ...
  <style>
   ...
   div#loghi{margin-top:100px;}
   
   
  </style>
</head>
<body>
 <div id="container" style="font-family: 'Open Sans', sans-serif; font-size:11px">
  <div id="wrap">
  <?php if ($_SESSION['username']!='guest'){require("inc/sessione.php");}?>
  <div id="header"><?php require_once ("inc/header.php"); ?></div><!--header-->
  <div id="content"><?php require_once ("inc/homeContent_alb.php"); ?></div><!--content-->
