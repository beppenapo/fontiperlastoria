...
<body onload="init();">
 ...
 <div id="logoSchedaDx"><img src="img/layout/loghiSchede/<?php echo($logo);?>.png" alt="logo scheda archeo" /></div>
...
/*
$("#noMapAlert").hide();
var numPoly = $("#numPoly").val();
var numLine = $("#numLine").val();
//alert(numPoly+'\n'+numLine); return false;
if(numPoly == 0 && numLine == 0){
   $('#smallMap').attr('id','noMap');
   $("#smallMapPanel").hide();
   $("#noMapAlert").show();
   return false;
}
...
//var width = imgThumb.width();    // Current image width
//var height = imgThumb.height();  // Current image height
