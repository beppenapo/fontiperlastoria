...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="IT" >
 <head>
  ...
  <style>
   div#accordion a{color:rgb(91,255,36);}
   .ui-accordion .ui-accordion-content,.ui-accordion-header, #accordion h3{
     border:1px solid rgb(91,255,36) !important; 
    ...
    p.sezFontiP:hover,.ui-state-active a, .ui-state-active a:link, .ui-state-active a:visited, #accordion a:hover, .ui-state-active, .ui-widget-content .ui-state-active, .ui-widget-header .ui-state-active{color:#fff !important;background-color:rgb(91,255,36) !important;}
...
<body>
 <div id="container">
  ...
  <div id="content"><?php require_once ("inc/fontiContent.php"); ?></div><!--content-->
